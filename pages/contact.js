            ...
            <div className="container">
                <div className="contactformp">
                    <div className="leftcontp">
                        ...
                        <p>Thinking about a new project? Let's make it happen!</p>
                        ...
                        <div className="leftsociinfo">
                            <ul>
                                <li><FaPhoneVolume /> <span>Phone: <a href="tel:+5519981540959" rel="nofollow" target="_blank">+55-19981540959</a></span></li>
                                ...
                                <li><GrLinkedin /> <span>Linkedin: <a href="https://www.linkedin.com/in/leonardo-de-godoy-junior/" rel="nofollow" target="_blank">Acess</a></span></li>
                                <li><FaGithub /> <span>Github: <a href="https://github.com/LeoGjr" rel="nofollow" target="_blank">Acess</a></span></li>
                            </ul>
                        </div>
                    </div>
                    <div className="rightcontp">
                        <form onSubmit={createProduct}>
                            ...
                            <div className="rightcontinputs">
                                ...
                                <input type="text" value={company} onChange={ev => setCompany(ev.target.value)} placeholder="Company" />
                            ...
                            <div className="rightconttitle">
                                <h2>What service are you looking for for your project?</h2>
                            </div>
